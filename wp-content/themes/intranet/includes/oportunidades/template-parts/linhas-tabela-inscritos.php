...
foreach ( $participantes as $participante ) :
    ...
    <tr data-inscricao-id="<?php echo esc_attr($participante['id']); ?>">
        ...
        <?php $url = Curriculo::get_link_visualizar_curriculo( $participante['user_id'] ); ?>
        ...
        <td><a href="<?= $url; ?>" class="btn-ver-curriculo" data-user="<?= $participante['user_id']; ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Ver CV</a></td>
        <td class="text-center">
            <?php
