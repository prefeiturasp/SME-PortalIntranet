jQuery(document).ready(function($) {    
    $("#exportar-cortesias").click(function(e) {
        e.preventDefault();
        const button = $(this);
        ...
        $.ajax({
            ...
            type: "POST",
            data: {
                action: "exportar_cortesias_excel",
                post_id: button.data("post-id"),
                _ajax_nonce: exportVarsCorte.nonce
            },
            xhrFields: {
                responseType: "blob"
            },
            success: function(data) {
                const filename = `relatorio_inscritos_${exportVarsCorte.dataAtual}.xlsx`;
