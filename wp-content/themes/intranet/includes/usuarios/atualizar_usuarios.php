...
if (isset($_FILES['file'])) {
    ...
    if ($xlsx = SimpleXLSX::parse($_FILES['file']['tmp_name']) ) {
        ...
        $api_url = getenv('SMEINTEGRACAO_API_URL') . '/api/AutenticacaoSgp/AlterarEmail';
        $usuarios = $xlsx->rows();
            ...
            foreach($usuarios as $usuario){
                ...
                if ( is_wp_error( $response ) ) {
                    ...
                    if($response['response']['code'] == 601){
                        ...
                        echo "</tr>";
                        //echo "Usuario: " . $usuario[1] . " - RF/EOL: " . $usuario[2] . " - " . $response['body'] . " <br>";
                        ...
                        echo "</tr>";
                        //echo "Usuario: " . $usuario[1] . " - RF/EOL: " . $usuario[2] . " - Usuário cadastrado com sucesso <br>";
                    } else {
                        echo "<tr>";
                            echo "<td>" . $usuario[1] . "</td>";
                            echo "<td>" . $usuario[2] . "</td>";
                        ...
                        echo "</tr>";
                        //echo "Usuario: " . $usuario[1] . " - RF/EOL: " . $usuario[2] . " - Ocorreu um erro, verifique os dados e tente novamente. <br>";
                    }
