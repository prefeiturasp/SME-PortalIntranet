            ...
            <div class="row social-block">
                <div class="col-sm-5">
                    ...
                    <?php if(get_sub_field('fx_fl1_pagina_2_2')): ?>
                        <a href="<?php echo get_sub_field('fx_fl1_pagina_2_2'); ?>"><button type="button" class="btn btn-primary btn-sm px-3"><i class="fa fa-instagram" aria-hidden="true"></i> | Instagram</button></a>
                    <?php endif; ?>
    ...
    ?>
        <div class="row social-block">
            <div class="col-sm-5">
                ...
                <hr>
                <?php if(get_sub_field('fx_fl1_pagina_2_2')): ?>
                    <a href="<?php echo get_sub_field('fx_fl1_pagina_2_2'); ?>"><button type="button" class="btn btn-primary btn-sm px-3"><i class="fa fa-facebook-square" aria-hidden="true"></i> | Facebook</button></a>
                <?php endif; ?>
        ...
        <div class="container">
            <div class="row social-block">
                <div class="col-sm-12">
                    ...
                    <?php if(get_sub_field('fx_fl1_pagina_2_2')): ?>
                        <a href="<?php echo get_sub_field('fx_fl1_pagina_2_2'); ?>"><button type="button" class="btn btn-primary btn-sm px-3"><i class="fa fa-youtube-play" aria-hidden="true"></i> | Youtube</button></a>
                    <?php endif; ?>
