<?php
    // Area Promotora
    $url = 'https://acervodigital.sme.prefeitura.sp.gov.br/wp-json/wp/v2/promotora/?per_page=99';
    ...
    // Formacao
    $url = 'https://acervodigital.sme.prefeitura.sp.gov.br/wp-json/wp/v2/formacao/?per_page=99';
    ...
    // Publico Alvo
    $url = 'https://acervodigital.sme.prefeitura.sp.gov.br/wp-json/wp/v2/publico/?per_page=99';
...
<div class="container">
    <div class="row">
            <?php
                ...
                $url = 'https://acervodigital.sme.prefeitura.sp.gov.br/wp-json/wp/v2/acervo/?per_page=' . $qtd . '&page=' . $pagina . '&filter[categoria_acervo]=propostas-formativas';
                if($_GET['promotora'] && $_GET['promotora'] != '')
