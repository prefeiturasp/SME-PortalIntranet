...
class Sancao_Options_Page {
    ...
    function box_form() {
        ...
        $results = array_merge( $sorteios, $cortesias );
        ...
        <script>
            jQuery(document).ready(function($){
                ...
                $('#buscar-participantes').on('click', function(e){
                    ...
                    let tipo = $('#post_id_select option:selected').data('tipo')
                    ...
                    Swal.fire({
                        ...
                        html: tipo === 'cortesia' ? 'Estamos localizando participantes inscritos...' : 'Estamos localizando participantes sorteados...',
                    ...
                    // Chamada AJAX
                    $.post(ajaxurl, {
                        action: tipo === 'cortesia' ? 'exibir_lista_participantes_cortesia_sancao' : 'exibir_lista_sorteados_por_data',
                        post_id: post_id,
