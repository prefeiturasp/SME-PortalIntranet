...
class LoadDependences
{
	...
	public function custom_formats_public(){
		...
		wp_register_script('valida-inscricao-cortesias',  STM_THEME_URL . 'classes/assets/js/valida-inscricao-cortesias.js', array ('jquery'), '1.0.0', true);

		add_action('wp_enqueue_scripts', function () {
			if ( is_singular('cortesias') ) {
				wp_enqueue_script('valida-inscricao-cortesias');
				return;
			}
		...
		wp_register_script('cortesia-js', STM_THEME_URL . 'js/cortesia.js?v=1.0');
