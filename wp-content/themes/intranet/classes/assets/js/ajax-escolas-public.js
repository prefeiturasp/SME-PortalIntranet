jQuery(document).ready(function ($) {
    ...
    $('#formulario_busca_escola').submit(function (e) {
        ...
        var endpoint_consulta_escola = 'https://escolaaberta.sme.prefeitura.sp.gov.br/api/escolas/?tipoesc=' + busca_tipo_de_escola + '&search=' + busca_escola + '&dre=' + busca_dre;
...
/*                    onPageClick: function (event, page) {
                    ...
                    var endpoint_consulta_escola = 'https://escolaaberta.sme.prefeitura.sp.gov.br/api/escolas/?tipoesc=' + busca_tipo_de_escola + '&search=' + busca_escola + '&dre=' + busca_dre + '&page='+page;
    ...
    function busca_tipo_escola() {
        var endpoint_search_tipo_escola = "https://escolaaberta.sme.prefeitura.sp.gov.br/api/tipo_escola";
    ...
    function busca_escola() {
        ...
        $("#busca_escola").on('keyup paste', function () {
            ...
            var endpoint_search_escolas = "https://escolaaberta.sme.prefeitura.sp.gov.br/api/escolas/?search=" + busca_escola;
    ...
    function busca_dre() {
        ...
        var endpoint_search_dre = "https://escolaaberta.sme.prefeitura.sp.gov.br/api/diretorias";
