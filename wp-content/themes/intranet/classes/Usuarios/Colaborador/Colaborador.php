...
class Colaborador
{
	...
	public function remove_menus(){
		...
		if ($usuario->roles[0] === 'contributor') {
			...
			remove_menu_page('edit.php?post_type=destaque'); // Recados
			remove_menu_page('edit.php?post_type=portais'); // Portais
			remove_menu_page('edit.php?post_type=intranet-faq'); // FAQ
			remove_menu_page('edit.php?post_type=parceiros'); // Parceiros
			remove_menu_page('edit.php?post_type=info-sme-explica'); // SME Explica
			remove_menu_page('edit.php?post_type=mural-professores'); // Mural de Professores
			...
			remove_menu_page('edit.php?post_type=noticia'); // Noticias
			...
			remove_menu_page('admin.php?page=microsoft-clarity');
