    ...
    if ( isset( $_COOKIE['redirect_to'] ) ) {
        ...
        if(isset($_GET['expirado']) && $_GET['expirado'] != ''){
            if($_GET['evento'] && $_GET['evento'] != ''){
                ...
                wp_redirect( home_url('index.php/inicial/?expirado='.$_GET['expirado'].'&tipo='.$_GET['tipo']) ); exit;
            }
        } elseif(isset($_GET['confirmacao']) && $_GET['confirmacao'] != ''){

            if ( $_GET['tipo'] && !empty( $_GET['tipo'] ) ) {
                wp_redirect( home_url( 'index.php/inicial/?tipo='.$_GET['tipo'].'&confirmacao='.$_GET['confirmacao'] ) ); exit;
            }
            ...
            if ( $_GET['tipo'] && !empty( $_GET['tipo'] ) ) {
                wp_redirect( home_url('index.php/inicial/?tipo='.$_GET['tipo'].'&conf-expirado='.$_GET['conf-expirado']) ); exit;
            }
